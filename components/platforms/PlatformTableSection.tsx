...
const PlatformTableSection = async () => {
            ...
            {data?.map((platform: any, index: number) => (
              ...
              >
                ...
                <TableCell className="text-right text-white font-bold border-b border-white/10 pr-4">
                  <span className="uppercase text-sm">{platform.shortname}</span>
                </TableCell>

                <TableCell className="text-right text-white font-medium border-b border-white/10 pr-4">
                  <span className="text-green-400 uppercase font-bold text-sm">{platform.native_coin_id}</span>
                </TableCell>
...
export default PlatformTableSection
