      ...
      <Table className="min-w-[500px] w-full border-separate border-spacing-0 bg-[#030f1f]">
        <TableHeader>
          <TableRow className="hover:bg-transparent border-none">
            ...
            <TableHead className="sticky left-[40px] bg-[#030f1f] z-20 min-w-[140px] pl-4 text-[12px] tracking-widest uppercase font-bold text-white border-b border-gray-600">nama aset</TableHead>
            ...
            <TableHead className="text-right pl-4 text-[12px] tracking-widest font-bold text-white border-b border-gray-600">1j %</TableHead>
            ...
            <TableHead className="text-right pl-4 text-[12px] tracking-widest font-bold text-white border-b border-gray-600">7h %</TableHead>
            ...
            <TableHead className="text-right pl-4 text-[12px] tracking-widest uppercase font-bold text-white pr-6 border-b border-gray-600">7 hari terakhir</TableHead>
          </TableRow>
        </TableHeader>
        ...
        <TableBody>
          {Array.from({ length: 10 }).map((_, i) => (
            <TableRow key={i} className="hover:bg-transparent">
              ...
              <TableCell className="sticky left-[40px] z-10 py-4 pl-4 bg-[#030f1f] border-b border-white/10 min-w-[140px]">
