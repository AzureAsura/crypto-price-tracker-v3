    ...
    <>
      ...
      <div className="page">
        ...
        >
          ...
          >
            Wah, traffik data pasar lagi padat banget nih. Sistem kami butuh istirahat sejenak dari permintaan API. Coba klik tombol di bawah dalam beberapa detik lagi ya!
          </motion.p>
